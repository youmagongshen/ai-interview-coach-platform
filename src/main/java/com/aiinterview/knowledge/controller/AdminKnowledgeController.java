...
@RequestMapping("/inv/admin/knowledge")
public class AdminKnowledgeController {
    ...
    public ApiResponse<PageResponse<KnowledgeDocVO>> pageDocuments(
        ...
        return ApiResponse.ok(knowledgeService.pageDocuments(roleId, status, docType, keyword, page, pageSize));
    }
    ...
    public ApiResponse<Boolean> deleteDocument(@PathVariable Long docId) {
        return ApiResponse.ok(knowledgeService.deleteDocument(docId));
    }
    ...
    public ApiResponse<Boolean> deleteChunk(@PathVariable Long chunkId) {
        return ApiResponse.ok(knowledgeService.deleteChunk(chunkId));
    }
